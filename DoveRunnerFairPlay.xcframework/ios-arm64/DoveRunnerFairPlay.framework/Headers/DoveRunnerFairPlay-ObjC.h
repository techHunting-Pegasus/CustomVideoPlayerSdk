...
#ifndef DOVERUNNERFAIRPLAY_SWIFT_H
#define DOVERUNNERFAIRPLAY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DoveRunnerFairPlay",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class License;
@interface ContentKey (SWIFT_EXTENSION(DoveRunnerFairPlay))
...
SWIFT_CLASS("_TtC18DoveRunnerFairPlay8Customer")
@interface Customer : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@interface Customer (SWIFT_EXTENSION(DoveRunnerFairPlay))
...
SWIFT_CLASS("_TtC18DoveRunnerFairPlay18DoveRunnerFairPlay")
...
@class NSURL;
@protocol FairPlayDownloadDelegate;
@class DownloadTask;
@interface DoveRunnerFairPlay (SWIFT_EXTENSION(DoveRunnerFairPlay))
- (DownloadTask * _Nonnull)createDownloadTaskWithUrl:(NSURL * _Nonnull)url userId:(NSString * _Nonnull)userId contentId:(NSString * _Nonnull)contentId token:(NSString * _Nonnull)token downloadOptions:(NSString * _Nonnull)downloadOptions isCelluraAccess:(BOOL)isCelluraAccess downloadDelegate:(id <FairPlayDownloadDelegate> _Nullable)downloadDelegate SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,deprecated=0.0.1,message="Use the `createDownloadTask(_ config:downloadCellerAccess:isMakeAssetDownloadTask:downloadMinimumBitrate:delegate:` instead") SWIFT_AVAILABILITY(ios,introduced=11.0);
...
- (DownloadTask * _Nonnull)createDownloadTaskWithUrl:(NSURL * _Nonnull)url userId:(NSString * _Nonnull)userId contentId:(NSString * _Nonnull)contentId optionalId:(NSString * _Nonnull)optionalId token:(NSString * _Nonnull)token licenseUrl:(NSString * _Nonnull)licenseUrl appleCertUrl:(NSString * _Nonnull)appleCertUrl downloadOptions:(NSString * _Nonnull)downloadOptions isCelluraAccess:(BOOL)isCelluraAccess isAVAssetDownloadTask:(BOOL)isAVAssetDownloadTask downloadDelegate:(id <FairPlayDownloadDelegate> _Nullable)downloadDelegate SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,deprecated=0.0.1,message="Use the `createDownloadTask(_ config:downloadCellerAccess:isMakeAssetDownloadTask:downloadMinimumBitrate:delegate:` instead") SWIFT_AVAILABILITY(ios,introduced=11.0);
- (DownloadTask * _Nonnull)createDownloadTaskWithUrlAsset:(AVURLAsset * _Nonnull)urlAsset userId:(NSString * _Nonnull)userId contentId:(NSString * _Nonnull)contentId token:(NSString * _Nonnull)token licenseUrl:(NSString * _Nonnull)licenseUrl appleCertUrl:(NSString * _Nonnull)appleCertUrl downloadOptions:(NSString * _Nonnull)downloadOptions isCelluraAccess:(BOOL)isCelluraAccess isAVAssetDownloadTask:(BOOL)isAVAssetDownloadTask downloadDelegate:(id <FairPlayDownloadDelegate> _Nullable)downloadDelegate SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,deprecated=0.0.1,message="Use the `createDownloadTask(_ config:downloadCellerAccess:isMakeAssetDownloadTask:downloadMinimumBitrate:delegate:` instead") SWIFT_AVAILABILITY(ios,introduced=11.0);
- (DownloadTask * _Nonnull)createDownloadTaskWithUrl:(NSURL * _Nonnull)url userId:(NSString * _Nonnull)userId contentId:(NSString * _Nonnull)contentId contentKeyIDList:(NSArray<NSString *> * _Nonnull)contentKeyIDList token:(NSString * _Nonnull)token licenseUrl:(NSString * _Nonnull)licenseUrl appleCertUrl:(NSString * _Nonnull)appleCertUrl downloadOptions:(NSString * _Nonnull)downloadOptions isCelluraAccess:(BOOL)isCelluraAccess isAVAssetDownloadTask:(BOOL)isAVAssetDownloadTask downloadDelegate:(id <FairPlayDownloadDelegate> _Nullable)downloadDelegate SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,deprecated=0.0.1,message="Use the `createDownloadTask(_ config:downloadCellerAccess:isMakeAssetDownloadTask:downloadMinimumBitrate:delegate:` instead") SWIFT_AVAILABILITY(ios,introduced=11.2);
@end
...
- (DownloadTask * _Nullable)createDownloadTaskWithDrm:(FairPlayConfiguration * _Nonnull)config delegate:(id <FairPlayDownloadDelegate> _Nullable)delegate downloadCellurAccess:(BOOL)downloadCellurAccess makeAssetDownloadTask:(BOOL)makeAssetDownloadTask downloadMinimumBitrate:(NSString * _Nullable)downloadMinimumBitrate SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=11.2);
...
///
/// returns:
/// Returns <code>OfflineExpiryDate</code>.
- (OfflineExpiryDate * _Nonnull)getOfflineLicenseExpiryDateWithFind:(NSString * _Nonnull)contentId SWIFT_WARN_UNUSED_RESULT;
...
/// You can create the instance by using (DoveRunnerFairPlay object).<code>createDownloadTask(config:downloadCellerAccess:isMakeAssetDownloadTask:downloadMinimumBitrate:delegate:)</code>.
/// You can also cancel current download using the same instance.
SWIFT_CLASS("_TtC18DoveRunnerFairPlay12DownloadTask") SWIFT_AVAILABILITY(ios,introduced=11.0)
...
SWIFT_CLASS("_TtC18DoveRunnerFairPlay21FairPlayConfiguration")
...
SWIFT_PROTOCOL("_TtP18DoveRunnerFairPlay24FairPlayDownloadDelegate_")
@protocol FairPlayDownloadDelegate <NSObject>
...
SWIFT_PROTOCOL("_TtP18DoveRunnerFairPlay23FairPlayLicenseDelegate_")
...
/// DoveRunner DRM-related custom information if present in the manifest.
/// Use this class to:
/// <ul>
///   <li>
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC18DoveRunnerFairPlay17HLSPlaylistParser")
@interface HLSPlaylistParser : NSObject
/// HLSPlaylistParser의 기본 생성자입니다.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC18DoveRunnerFairPlay7License")
@interface License : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@class NSDate;
@interface License (SWIFT_EXTENSION(DoveRunnerFairPlay))
...
SWIFT_CLASS("_TtC18DoveRunnerFairPlay13LicenseResult")
...
SWIFT_CLASS("_TtC18DoveRunnerFairPlay17OfflineExpiryDate")
